...
function Capabilities.Summary()
  ...
  return {
    ...
    approvalGate = Capabilities.ApprovalGate()
  }
end

function Capabilities.ApprovalGate()
  return {
    releaseLevel = "v5",
    status = "blocked",
    surface = "Stepmania-Sidecar Lua event bundle",
    runtimeBoundary = "theme-side telemetry only",
    canReceiveGameplayCommands = false,
    canExecuteGameplayMutation = false,
    productionMutationBlocked = true,
    dryRunRequired = true,
    operatorApprovalRequired = true,
    auditRequired = true,
    rollbackRequired = true,
    blockerReason = "approved-runtime-bridge-gameplay-proof-missing",
    missingProofFields = {
      "approvedRuntimeBridge",
      "operatorApproval",
      "auditTrail",
      "rollbackPlan",
      "liveGameplayEffectObserved",
      "canExecuteGameplayMutation"
    }
  }
end
